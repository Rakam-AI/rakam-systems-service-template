...
VS = VectorStore(base_index_path="vector_stores_for_test/example_baseIDXpath", embedding_model="sentence-transformers/all-MiniLM-L6-v2")
VSManager = VSManager(vector_store=VS)
VSManager.inject_vsfiles("data/files", collection_name="test")
